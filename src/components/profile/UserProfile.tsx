...
export const UserProfile: React.FC<UserProfileProps> = ({ userId, isOwnProfile = false }) => {
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="flex items-center text-gray-600">
                  {user.role}
                  {user.is_verified && (
                    <span className="ml-2 bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full">Verified</span>
                  )}
                </p>
              </div>
            </div>
          ...
          {user.total_reviews > 0 && (
            <div className="flex items-center mt-4">
              ...
              <span className="ml-2 text-gray-600">{user.rating.toFixed(1)} ({user.total_reviews} reviews)</span>
            </div>
          )}
        ...
        {reviews.length > 0 && (
          <div className="bg-white p-6 rounded-xl shadow-sm">
            ...
            {reviews.map((review) => (
              <div key={review.id} className="border-b pb-4 mb-4 last:mb-0 last:border-none">
